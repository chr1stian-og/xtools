...
app.post("/api/getInterfaceNumber", authenticateToken, async (req, res) => {
...
app.post("/api/getInterface", authenticateToken, async (req, res) => {
  const { client } = req.body;
...
app.post("/api/getWifiNameAndPassword", authenticateToken, async (req, res) => {
  const { client } = req.body;
...
app.post("/api/removeHack", authenticateToken, async (req, res) => {
  const { client } = req.body;
...
app.post("/api/reboot", authenticateToken, async (req, res) => {
  const { client } = req.body;
